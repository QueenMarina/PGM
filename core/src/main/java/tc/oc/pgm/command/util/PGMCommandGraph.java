...
import tc.oc.pgm.command.GlobalStatsCommand;
...
import tc.oc.pgm.command.PauseCommand;
import tc.oc.pgm.command.PreserveHotbarOrderCommand;
import tc.oc.pgm.command.ProximityCommand;
import tc.oc.pgm.command.RaindropCommand;
import tc.oc.pgm.command.RankCommand;
...
public class PGMCommandGraph extends CommandGraph<PGM> {
  ...
  protected void registerCommands() {
    ...
    register(new PreserveHotbarOrderCommand());
    register(new ProximityCommand());
    register(new RaindropCommand());
